 ...
 *
 * Tests for the OIDC assertion grant flow.
 */
...
public class AssertionGrantTest extends AbstractTestRealmKeycloakTest {
    ...
    /**
     * Test to ensure the grant fails if the assertion grant feature has not been enabled. HTTP status 501
    ...
    public void checkFeatureDisabled() {
        ...
        Assert.assertEquals(501, sendAssertionGrant(null).getStatus());
    }
    ...
    public void checkInvalidSignature() throws CertificateEncodingException {
        ...
        X509Certificate cert = CertificateUtils.generateV1SelfSignedCertificate(keyPair, "CN=test-cert");
    ...
    private void setClientCrossDomainTrust(String clientId, Set<String> trustIds){
        ...
        attrs.put(Constants.OIDC_ASSERTION_GRANT_TRUSTED_ISSUER, serialize(trustIds));
