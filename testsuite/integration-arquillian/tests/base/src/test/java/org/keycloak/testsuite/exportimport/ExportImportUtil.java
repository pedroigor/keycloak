...
public class ExportImportUtil {
    ...
    public static void assertDataImportedInRealm(Keycloak adminClient, KeycloakTestingClient testingClient, RealmRepresentation realm) throws IOException {
        ...
        Assert.assertNull(admin.getLastUpdatedTimestamp());
        ...
        Assert.assertEquals(new Long(123754), wburke.getLastUpdatedTimestamp());
        ...
        Assert.assertEquals(new Long(123755), loginclient.getLastUpdatedTimestamp());
