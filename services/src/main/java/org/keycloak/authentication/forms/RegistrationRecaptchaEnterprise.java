...
public class RegistrationRecaptchaEnterprise extends AbstractRegistrationRecaptcha {
    ...
    protected boolean validateConfig(Map<String, String> config) {
        return !(Stream.of(PROJECT_ID, SITE_KEY, SECRET_KEY, ACTION)
    ...
    private HttpPost buildEnterpriseAssessmentRequest(String captcha, Map<String, String> config) throws IOException {
