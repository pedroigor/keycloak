 ...
 * as blocking).
 *
 * <p>Note that this filter does not close the {@link KeycloakSession}. The reason is that closing it should be done at the
 ...
 * callbacks are not designed to run blocking code.
 *
