...
public class HostnameOptions {
    ...
    public static final Option hostnameAdmin = new OptionBuilder<>("hostname-admin", String.class)
            .category(OptionCategory.HOSTNAME)
    ...
    public static final Option hostnameStrict = new OptionBuilder<>("hostname-strict", Boolean.class)
            .category(OptionCategory.HOSTNAME)
    ...
    public static final Option hostnameStrictHttps = new OptionBuilder<>("hostname-strict-https", Boolean.class)
            .category(OptionCategory.HOSTNAME)
    ...
    public static final Option hostnameStrictBackchannel = new OptionBuilder<>("hostname-strict-backchannel", Boolean.class)
            .category(OptionCategory.HOSTNAME)
    ...
    public static final Option hostnamePath = new OptionBuilder<>("hostname-path", String.class)
            .category(OptionCategory.HOSTNAME)
            .description("This should be set if proxy uses a different context-path for Keycloak.")
            .build();

    public static final Option hostnamePort = new OptionBuilder<>("hostname-port", Integer.class)
            .category(OptionCategory.HOSTNAME)
